...
var shouldOmitLazy = function shouldOmitLazy() {
  var omitLazyForSlides = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
...
var renderSlides = function renderSlides(spec) {
  ...
  react__WEBPACK_IMPORTED_MODULE_0___default.a.Children.forEach(spec.children, function (elem, index) {
    ...
    if (!spec.lazyLoad || spec.lazyLoad && spec.lazyLoadedList.indexOf(index) >= 0 || shouldOmitLazy(spec.omitLazyForSlides, index)) {
      child = elem;
    } else {
                  ...
                  _extends(
                    {
                      ...
                      className: classnames__WEBPACK_IMPORTED_MODULE_1___default()(
                        "slick-track",
                        this.props.classes.slickSlider
                      ),
                      style: this.props.trackStyle
                    },
                    mouseEvents
...
<<<<<<< Updated upstream
            ...
            },
            {
              ...
              value: function render() {
                ...
                if (
                  ...
                  prevClasses["slick-disabled"] = true;
                  prevClasses[this.props.classes.slickDisable] = true;
                  prevHandler = null;
                }
            ...
            },
            {
              ...
              value: function render() {
                ...
                if (
                  ...
                  nextClasses["slick-disabled"] = true;
                  nextClasses[this.props.classes.slickDisable] = true;
                  nextHandler = null;
                }
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var defaultProps = {
          ...
          cssEase: "ease",
          classes: {
            slickArrow: "slickArrow-answear",
            // done
            slickPrev: "slickPrev-answear",
            // done
            slickNext: "slickNext-answear",
            // done
            slickSlide: "slickSlide-answear",
            //
            slickDisable: "slickDisable-answear",
            slickSlider: "slickSlider-answear",
            // done
            slickList: "slickList-answear",
            // done
